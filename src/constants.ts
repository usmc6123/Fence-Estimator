...
export const MATERIALS: MaterialItem[] = [
  ...
  { id: 'w-picket-pine', name: '1x6-6\' Pine Picket (Raw)', category: 'Picket', unit: 'each', cost: 2.85, description: 'Pressure-treated pine', imageUrl: 'https://images.thdstatic.com/productImages/1ba2667d-0dc4-4b85-b047-7a4660cfe8a7/svn/pressure-treated-lumber-194354-64_1000.jpg' },
  { id: 'w-picket-pine-stained', name: '1x6-6\' Pine Picket (Pre-Stained)', category: 'Picket', unit: 'each', cost: 4.85, description: 'Pressure-treated pine, pre-stained', imageUrl: 'https://images.thdstatic.com/productImages/1ba2667d-0dc4-4b85-b047-7a4660cfe8a7/svn/pressure-treated-lumber-194354-64_1000.jpg' },
  { id: 'w-picket-w-cedar', name: '1x6-6\' Western Red Cedar Picket (Raw)', category: 'Picket', unit: 'each', cost: 4.25, description: 'Premium Western Red Cedar', imageUrl: 'https://patriotfencekc.com/wp-content/gallery/aluminu/4-tall-solid-cedar-privacy-1x6x4.jpeg' },
  { id: 'w-picket-w-cedar-stained', name: '1x6-6\' Western Red Cedar Picket (Pre-Stained)', category: 'Picket', unit: 'each', cost: 6.25, description: 'Premium Western Red Cedar, pre-stained', imageUrl: 'https://patriotfencekc.com/wp-content/gallery/aluminu/4-tall-solid-cedar-privacy-1x6x4.jpeg' },
  { id: 'w-picket-j-cedar', name: '1x6-6\' Japanese Cedar Picket (Raw)', category: 'Picket', unit: 'each', cost: 3.75, description: 'Japanese Cedar (Sugi)', imageUrl: 'https://m.media-amazon.com/images/I/41b0RJrZRKL.jpg' },
  { id: 'w-picket-j-cedar-stained', name: '1x6-6\' Japanese Cedar Picket (Pre-Stained)', category: 'Picket', unit: 'each', cost: 5.75, description: 'Japanese Cedar (Sugi), pre-stained', imageUrl: 'https://m.media-amazon.com/images/I/41b0RJrZRKL.jpg' },
