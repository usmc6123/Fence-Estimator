...
export const MATERIALS: MaterialItem[] = [
  ...
  { id: 'cl-mesh-res-3', name: '11ga Galv Mesh 3\' (Residential)', category: 'Picket', unit: 'roll', cost: 162.50, description: '3ft residential grade fabric (50ft roll)' },
  { id: 'cl-mesh-res-4', name: '11ga Galv Mesh 4\' (Residential)', category: 'Picket', unit: 'roll', cost: 225.00, description: '4ft residential grade fabric (50ft roll)' },
  { id: 'cl-mesh-res-5', name: '11ga Galv Mesh 5\' (Residential)', category: 'Picket', unit: 'roll', cost: 287.50, description: '5ft residential grade fabric (50ft roll)' },
  { id: 'cl-mesh-res-6', name: '11ga Galv Mesh 6\' (Residential)', category: 'Picket', unit: 'roll', cost: 337.50, description: '6ft residential grade fabric (50ft roll)' },
  { id: 'cl-mesh-res-8', name: '11ga Galv Mesh 8\' (Residential)', category: 'Picket', unit: 'roll', cost: 437.50, description: '8ft residential grade fabric (50ft roll)' },
  // Commercial Mesh (9 Gauge)
  { id: 'cl-mesh-comm-3', name: '9ga Galv Mesh 3\' (Commercial)', category: 'Picket', unit: 'roll', cost: 212.50, description: '3ft commercial grade fabric (50ft roll)' },
  { id: 'cl-mesh-comm-4', name: '9ga Galv Mesh 4\' (Commercial)', category: 'Picket', unit: 'roll', cost: 275.00, description: '4ft commercial grade fabric (50ft roll)' },
  { id: 'cl-mesh-comm-5', name: '9ga Galv Mesh 5\' (Commercial)', category: 'Picket', unit: 'roll', cost: 337.50, description: '5ft commercial grade fabric (50ft roll)' },
  { id: 'cl-mesh-comm-6', name: '9ga Galv Mesh 6\' (Commercial)', category: 'Picket', unit: 'roll', cost: 387.50, description: '6ft commercial grade fabric (50ft roll)', imageUrl: 'https://image.made-in-china.com/318f0j00YTqfkIjPqHgb/-mp4.webp' },
  { id: 'cl-mesh-comm-8', name: '9ga Galv Mesh 8\' (Commercial)', category: 'Picket', unit: 'roll', cost: 487.50, description: '8ft commercial grade fabric (50ft roll)' },
  ...
  { id: 'cl-hw-tension-bar-8', name: "8' Tension Bar", category: 'Hardware', unit: 'each', cost: 18.50 },
  ...
  { id: 'cl-mesh-black-res-3', name: '11ga Black Mesh 3\' (Residential)', category: 'Picket', unit: 'roll', cost: 212.50, description: '3ft black vinyl fabric (50ft roll)' },
  { id: 'cl-mesh-black-res-4', name: '11ga Black Mesh 4\' (Residential)', category: 'Picket', unit: 'roll', cost: 275.00, description: '4ft black vinyl fabric (50ft roll)' },
  { id: 'cl-mesh-black-res-5', name: '11ga Black Mesh 5\' (Residential)', category: 'Picket', unit: 'roll', cost: 337.50, description: '5ft black vinyl fabric (50ft roll)' },
  { id: 'cl-mesh-black-res-6', name: '11ga Black Mesh 6\' (Residential)', category: 'Picket', unit: 'roll', cost: 387.50, description: '6ft black vinyl fabric (50ft roll)' },
  { id: 'cl-mesh-black-res-8', name: '11ga Black Mesh 8\' (Residential)', category: 'Picket', unit: 'roll', cost: 487.50, description: '8ft black vinyl fabric (50ft roll)' },
  
  // Black Commercial Mesh (9 Gauge)
  { id: 'cl-mesh-black-comm-3', name: '9ga Black Mesh 3\' (Commercial)', category: 'Picket', unit: 'roll', cost: 262.50, description: '3ft black vinyl fabric (50ft roll)' },
  { id: 'cl-mesh-black-comm-4', name: '9ga Black Mesh 4\' (Commercial)', category: 'Picket', unit: 'roll', cost: 325.00, description: '4ft black vinyl fabric (50ft roll)' },
  { id: 'cl-mesh-black-comm-5', name: '9ga Black Mesh 5\' (Commercial)', category: 'Picket', unit: 'roll', cost: 387.50, description: '5ft black vinyl fabric (50ft roll)' },
  { id: 'cl-mesh-black-comm-6', name: '9ga Black Mesh 6\' (Commercial)', category: 'Picket', unit: 'roll', cost: 437.50, description: '6ft black vinyl fabric (50ft roll)' },
  { id: 'cl-mesh-black-comm-8', name: '9ga Black Mesh 8\' (Commercial)', category: 'Picket', unit: 'roll', cost: 587.50, description: '8ft black vinyl fabric (50ft roll)' },
  ...
  { id: 'cl-hw-tension-bar-black-8', name: "8' Black Tension Bar", category: 'Hardware', unit: 'each', cost: 20.50 },
